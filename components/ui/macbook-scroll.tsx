...
export const MacbookScroll = ({
  ...
  useEffect(() => {
    ...
    calculateLanding();
    window.addEventListener('resize', calculateLanding);
    window.addEventListener('load', calculateLanding);
    
    return () => {
      window.removeEventListener('resize', calculateLanding);
      window.removeEventListener('load', calculateLanding);
    };
    ...
    >
      ...
      <style jsx>{`
        @media (max-width: 1023px) {
          [data-macbook-container] {
            min-height: 70vh !important;      /* Lebih pendek lagi */
            max-height: 70vh !important;      /* Batasi maksimal height */
