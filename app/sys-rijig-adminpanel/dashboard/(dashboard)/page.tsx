...
export default function AdminDashboardPage() {
  ...
  const quickStats = [
    { label: 'Total Pengelola', value: '24', icon: Users, color: 'text-blue-600' },
    { label: 'Active Companies', value: '18', icon: Building, color: 'text-green-600' },
    { label: 'Pending Approvals', value: '3', icon: FileText, color: 'text-orange-600' },
    { label: 'Reports Generated', value: '156', icon: BarChart3, color: 'text-purple-600' },
  ];

  const recentActivities = [
    { id: 1, action: 'New pengelola registration', company: 'PT. Waste Solutions', time: '2 hours ago' },
    { id: 2, action: 'Company profile updated', company: 'CV. Green Recycling', time: '4 hours ago' },
    { id: 3, action: 'Monthly report generated', company: 'System', time: '1 day ago' },
  ];

  const pendingApprovals = [
    { id: 1, company: 'PT. Eco Management', type: 'New Registration', submitted: '1 hour ago' },
    { id: 2, company: 'CV. Clean Earth', type: 'Profile Update', submitted: '3 hours ago' },
    { id: 3, company: 'PT. Green Solutions', type: 'New Registration', submitted: '5 hours ago' },
  ];
                ...
                {pendingApprovals.map((item) => (
                  <div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">{item.type} • {item.submitted}</p>
                    </div>
