...
export default function AdminDashboardPage() {
  ...
  // Data hardcode untuk development
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-purple-600">
              {stats.totalUsers.pengelolaDaurUlang}
            </div>
            <p className="text-xs text-muted-foreground">
          ...
          <CardContent className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-green-600">
                {formatWeight(stats.volumeSampah.terkumpul)}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-muted-foreground">Diproses</span>
              <span className="font-semibold text-blue-600">
                {formatWeight(stats.volumeSampah.diproses)}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-muted-foreground">Pending</span>
              <span className="font-semibold text-orange-600">
                {formatWeight(stats.volumeSampah.pending)}
              </span>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold">
                {formatCurrency(stats.revenue.harian)}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-muted-foreground">Bulan ini</span>
              <span className="font-semibold">
                {formatCurrency(stats.revenue.bulanan)}
              </span>
            </div>
            <div className="flex justify-between items-center">
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-sm text-muted-foreground">Hari ini</span>
              <span className="font-semibold text-blue-600">
                {stats.totalTransaksi.harian}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-muted-foreground">Bulan ini</span>
              <span className="font-semibold text-green-600">
                {stats.totalTransaksi.bulanan}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-muted-foreground">Total</span>
              <span className="font-semibold text-purple-600">
                {stats.totalTransaksi.total}
              </span>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 gap-3">
              ...
              >
                ...
                Review Pendaftaran ({stats.pendingApprovals})
              </Button>
